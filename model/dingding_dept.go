...
type DingdingDept struct {
	DeptId          int64  `json:"dept_id" gorm:"primaryKey;types:int(11);column:dept_id"`
	ParentId        int64  `json:"parent_id" gorm:"types:int(11);column:parent_id"`
	Name            string `json:"name" gorm:"types:varchar(128)"`
